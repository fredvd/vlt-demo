...
```
DEPLOY_ENV=prod
DEPLOY_HOST=vlt-demo.example.com
DEPLOY_PORT=22
DEPLOY_USER=plone
...
prod:
  hosts:
    vlt-demo.example.com:
      ansible_user: root
      host: vlt-demo
      hostname: vlt-demo.example.com
```
...
Deploy the stack defined in `devops/stacks/vlt-demo.example.com.yml` to the remote server with:
